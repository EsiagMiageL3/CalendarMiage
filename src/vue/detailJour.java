...
public class detailJour extends javax.swing.JFrame {
    ...
    public detailJour() {
        ...
        public detailJour(String jour, Date date) {
            this.setLocationRelativeTo(null);
            this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            this.setTitle("JTable");
            this.setSize(500, 500);
            cadre = new JPanel();
            this.cadre.setSize(490, 490);
