...
public class vueNewModule extends javax.swing.JFrame {
    ...
    public vueNewModule(final Formation formation) {
        ...
        this.btnEnregistrement.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				JOptionPane.showMessageDialog(null, "Le module " + nomModule() + " a ŽtŽ ajoutŽ avec succ�s ˆ la formation " + formation.nom_f);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("AbrŽviation du nom");
        jLabel2.setToolTipText("");
        jLabel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jLabel2.setOpaque(true);

        jTextField2.setText("Saisissez une abrŽviation");
        ...
        jLabel4.setText("Nombre de sŽances");
        ...
        jLabel5.setText("CrŽation d'un nouveau module de formation");
